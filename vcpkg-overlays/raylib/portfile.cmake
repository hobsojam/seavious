...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DCUSTOMIZE_BUILD=ON
        # OVERLAY FIX: raylib 6.0's cmake/ParseConfigHeader.cmake treats every
        # uncommented "#define SUPPORT_X 0" in config.h as default ON (it only
        # honors the old //-commented-out convention), so CUSTOMIZE_BUILD=ON
        # silently enables options that config.h disables by value. Two of
        # those break the library: SUPPORT_CUSTOM_FRAME_CONTROL makes
        # EndDrawing() skip SwapScreenBuffer()/PollInputEvents()/frame pacing
        # (window stays permanently blank at uncapped fps), and
        # SUPPORT_BUSY_WAIT_LOOP burns a core in WaitTime(). Force both OFF.
