...
- [ ] Ground target sprites (alien platforms/installations) — Relay Node,
      Mine, Casemate, and Tracking Turret first passes done (see Art
      below); Mobile Platform still to design. Land-based emplacement
      variants deliberately deferred to the Stage 2 mortar-target class
      (see README roster note) rather than reskins of the water designs
