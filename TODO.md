...
- [x] Ocean background tile art — second-pass programmatic version at
      `assets/tiles/ocean.png` (64x64, seamless both axes): calm dark water,
      broad noise-warped horizontal swell bands, rare 1px foam dashes,
      generated by `tools/gen-ocean-tile.ps1`. Replaces the first-pass
      32x32 dithered-chevron tile, which read as fabric/carpet rather than
      water (dense high-frequency pattern + 1px dither + small repeat);
      design principles recorded in the README palette section
