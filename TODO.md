...
- [x] Ocean background tile art — fourth-pass programmatic version at
      ...
      arcade water (Xevious/1942 style) — solid navy, whisper-subtle darker
      mottle, sparse white flecks — generated by `tools/gen-ocean-tile.ps1`.
      Passes 1-3 (dithered chevrons, swell bands, dappled patches) all read
      as fabric/stripes/pattern rather than water; lesson recorded in the
      README palette section
- [ ] Ocean ideas for the VFX pass, if the flat water ever needs more life:
      a second sparse foam-only overlay texture scrolling slightly faster
      than the base tile (parallax breaks tiling periodicity and adds depth
      cheaply), and/or multiple edge-compatible tile variants placed by a
      positional hash (prototyped: variants sharing noise-lattice borders
      tile seamlessly in any arrangement)
