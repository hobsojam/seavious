...
Map semantics:
  ...
  - `#` cells are terrain; contiguous cells merge into blocking
...
def parse_map(path):
    ...
    return events, merge_terrain(terrain_cells), length_px
...
def emit(events, terrain, length_px, out_path, source_rel):
    lines = [
...
def main(out_dir=None):
    ...
    events, terrain, length_px = parse_map(map_path)
    emit(events, terrain, length_px,
