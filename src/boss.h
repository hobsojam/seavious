...
// music hard-cuts), runs the part-driven fight, the death chain, and the
// salvage sequence that ends in stageClear. Player-weapon collisions
// against parts follow the strict class mapping: gun bullets touch only
// pods (and the exposed core), torpedoes only hull sections (and the
// exposed core); the mortar dome and the hull base have no weapon
// interaction at all - bare steel means no weapon works, and the base
// hull is the wreck-to-be, inert like every wreck.
